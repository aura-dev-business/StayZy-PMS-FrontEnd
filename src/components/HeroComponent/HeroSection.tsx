...
export default function HeroSection() {
  ...
  const initialTab = (searchParams.get('tab') === 'buy' ? 'For Sale' : 'For Rent') as 'For Sale' | 'For Rent';

  const [activeTab, setActiveTab] = useState<'For Sale' | 'For Rent'>(initialTab || "For Rent");
