...
export default function HeroSection() {
  ...
  // Normalize tab from URL to match state values
  const initialTabParam = searchParams.get('tab');
  const initialTab: 'For Sale' | 'For Rent' =
    initialTabParam === 'buy' ? 'For Sale' : initialTabParam === 'rent' ? 'For Rent' : 'For Sale';

  const [activeTab, setActiveTab] = useState<'For Sale' | 'For Rent'>(initialTab);
